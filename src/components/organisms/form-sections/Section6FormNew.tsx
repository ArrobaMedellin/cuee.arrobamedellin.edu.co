...
export function Section6FormNew() {
		...
		<Form {...form}>
			...
			>
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							<FormLabel>Grupos étnicos</FormLabel>
							<div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className='flex flex-row items-start space-x-3 space-y-0'>
								...
								<div className='space-y-1 leading-none'>
									<FormLabel>¿Es cuidador familiar?</FormLabel>
								</div>
								<FormMessage />
							</FormItem>
						)}
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className='flex flex-row items-start space-x-3 space-y-0'>
								...
								<div className='space-y-1 leading-none'>
									<FormLabel>¿Es concejal juvenil?</FormLabel>
								</div>
								<FormMessage />
							</FormItem>
						)}
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className='flex flex-row items-start space-x-3 space-y-0'>
								...
								<div className='space-y-1 leading-none'>
									<FormLabel>¿Es barrista certificado?</FormLabel>
								</div>
								<FormMessage />
							</FormItem>
						)}
