...
export function Section1Form() {
	...
	// Estados para manejar las selecciones de ubicación de nacimiento
	...
	const [selectedBirthDepartmentName, setSelectedBirthDepartmentName] =
		useState<string>('')
	const [selectedBirthCityName, setSelectedBirthCityName] = useState<string>('')
	const [selectedBirthCommuneId, setSelectedBirthCommuneId] = useState<
		number | undefined
	>()
	...
	const neighborhoods = useNeighborhoods(selectedBirthCommuneId)

	// Obtener ciudades del departamento seleccionado
	const citiesOfSelectedBirthDepartment = useMemo(() => {
